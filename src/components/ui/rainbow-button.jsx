/**
 * [INPUT]: 依赖 react、radix-ui 的 Slot、class-variance-authority 的 cva、@/lib/utils 的 cn
 * [OUTPUT]: 命名导出 RainbowButton + rainbowButtonVariants — 来自 @magicui/rainbow-button
 * [POS]: components/ui，渐变彩虹边框按钮，落地页 CTA 高亮使用
